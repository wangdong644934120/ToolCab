...
public class TestActivity extends Activity {
    ...
    private RecycleAdapterSave adapterDome;//声明适配器
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_viewsave);
        list = new ArrayList<>();
        for (int i=0;i<10;i++){
            list.add("这是第"+i+"个测试");
        }
        //
        adapterDome = new RecycleAdapterSave(context,null);
        /*
