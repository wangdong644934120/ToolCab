...
public class RecycleAdapterSave extends RecyclerView.Adapter<RecycleAdapterSave.MyViewHolder>{
    ...
    //构造方法，传入数据
    public RecycleAdapterSave(Context context, List<Tools> list){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        inflater = LayoutInflater.from(context).inflate(R.layout.item_save,parent,false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        for(ToolZT toolZT : Cache.listBX){
            if(toolZT.getEpc().equals(Cache.listOperaSave.get(position).getEpc())){
